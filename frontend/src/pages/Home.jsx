...
// High quality SVG vectors for Why Choose Us
const WhyIcons = {
  expert: (
  ...
  <div className="min-h-screen">
      ...
      <div className="section-wrapper text-center">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: WhyIcons.expert,
                title: "Expert Stylists",
                desc: "Trained professionals with years of hands-on experience in modern beauty techniques.",
              },
              {
                icon: WhyIcons.booking,
                title: "Easy Online Booking",
                desc: "Book your appointment in seconds — pick your service, choose a slot, and you're set.",
              },
              {
                icon: WhyIcons.premium,
                title: "Premium Products",
                desc: "Only the finest internationally recognized products touch your skin and hair.",
              },
            ].map((item) => (
              <motion.div
                key={item.title}
    ...
    <section className="py-16 bg-cream overflow-hidden">
      <div className="section-wrapper">
        ...
        >
          <h2 className="font-display text-3xl font-bold text-berry-500">
            Inside <span className="italic text-blush-400">LumiGlow</span>
          </h2>
        </motion.div>
    ...
    <section className="py-16 bg-blush-50">
      <div className="section-wrapper text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="font-display text-4xl font-bold text-berry-500 mb-4">
            Ready to <span className="italic text-blush-400">Glow Up?</span>
          </h2>
          <p className="font-body text-berry-400 mb-8 text-lg">
